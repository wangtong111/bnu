var MarketSelect = cc.Layer.extend({
    ...
    onTouchEnded : function(touch,event){
        ...
        if(black){
            ...
            black.setPosition(size.width/2,size.height/2);
