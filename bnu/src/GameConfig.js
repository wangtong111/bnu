...
var MARKET_LABEL = {};
MARKET_LABEL[1] = {};
MARKET_LABEL[1][1] = "欢迎来到新的章节。请选择小汽车、谷仓、\n停车标志的图案和所有的词汇。";
MARKET_LABEL[1][2] = "欢迎来到第二关。你还记得研究二吗？\n它和研究一有什么不同？\n请选择纸片人和所有的词汇。";
MARKET_LABEL[1][3] = "欢迎来到第三关。新的研究在等待着我们！\n请选择小汽车、谷仓、停车标志和所有的词汇。";
MARKET_LABEL[1][4] = "欢迎来到第四关，这是最后一关了。\n请选择校车和所有的词汇吧。";

MARKET_LABEL[2] = {};
MARKET_LABEL[2][1] = "欢迎来到认知地图的章节！\n请选择所有的小鼠、水和食物。";
MARKET_LABEL[2][2] = "恭喜你进入了第二关。\n你还记得“潜伏学习”的实验吗？\n请选择迷宫地图、小老鼠们、食物和水。";
MARKET_LABEL[2][3] = "欢迎来到第三关。\n在空间定向的实验中，\n你需要选择塞子和一个数字符号。";

MARKET_LABEL[3] = {};
MARKET_LABEL[3][1] = "大家好，欢迎来到新的章节。\n我们将在这一章里与恒河猴幼崽\n和代理妈妈们一起探索爱的起源。\n请选择恒河猴幼崽和所有的代理妈妈吧。";
MARKET_LABEL[3][2] = "欢迎来到第二关。在开阔的场地里，\n幼猴和代理妈妈的关系又是怎样的呢？\n请选择恒河猴的幼崽吧。";
MARKET_LABEL[3][3] = "欢迎来到第三关。为了进一步研究\n接触安慰和依恋，\n研究者让小猴和代理\n妈妈分开了一段时间。\n此外，我们还会简单看看控制组小猴的情况。\n请选择恒河猴的幼崽吧。";

MARKET_LABEL[4] = {};
MARKET_LABEL[4][1] = "欢迎来到“迷信的鸽子”的章节，\n我们将学习如何使用操作性条件反射\n的知识让鸽子做出“迷信”的行为。\n请把所有的东西都选上吧。";
MARKET_LABEL[4][2] = "“迷信的鸽子”研究得出了什么结果呢？\n请选择所有的鸽子吧。";

MARKET_LABEL[5] = {};
MARKET_LABEL[5][1] = "欢迎来到新的章节~\n在这里，情绪化的小阿尔伯特揭示了条件反射\n和行为主义思想的哪些知识呢？\n请选择除了两个小婴儿以外的所有物品、\n小动物和面孔吧。";

MARKET_LABEL[6] = {};
MARKET_LABEL[6][1] = "欢迎来到新的章节。\n在这里，我们将学习教师的期望\n如何影响学生的智力增长。\n请选择除了五位小朋友外的其他事物吧。";
MARKET_LABEL[6][2] = "八个月之后，\n研究者们又来到了橡树学校。\n学生们发生了什么变化呢？\n请选择除了小朋友们以外的其他事物吧。";
